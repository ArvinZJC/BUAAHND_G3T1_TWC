 ...
 * jquery.org/license
 * 
 * added to the project on 28 October, 2018
 * 
 * modified by Zhao Jichen and Ye Yifan
 */
...
var Dml = {};
    Dml.fun = {
        ...
        showComfirmDialog: function(obj){
            var $Box = $('#jsComfirmDialig'),
                h1 = obj.h1 || 'Confirm Submission',
                h2 = obj.h2 || 'Do you confirm the submission?',
    ...
    //regular expressions for sign-up information
    Dml.regExp = {
        ...
        zsNumber: /^(-?[1-9]\d*|0)$/,
        name: /^[\u4e00-\u9fa5a-zA-Z]+$/,
        username: /(^[\u4e00-\u9fa5a-zA-Z]+$)|(^1([38]\d|4[57]|5[0-35-9]|7[06-8]|8[89])\d{8}$)|(^([a-zA-Z0-9_-])+@([a-zA-Z0-9_-])+(.[a-zA-Z0-9_-])+)/,
        pwd: /^([^\u4e00-\u9fa5]{6,20})$/,
        verifyCode: /^[a-zA-z]{5}$/,
        phoneCode: /^\d{6}$/,
        emailCode: /^\d{4}$/,
    ...
    //tips for sign-up information
    Dml.Msg = {
        epUserName: 'Please enter your username!',
        erUserName: 'Please enter a correct username!',
        epPhone: 'Please enter your mobile phone number!',
        erPhone: 'Please enter a correct mobile phone number!',
        epTel: 'Please enter your telephone number',
        erTel: 'Please enter a correct telephone number (format: area code-numbers)!',
        epVerifyCode: 'Please enter your verification code!',
        erVerifyCode: 'Please enter a correct verification code',
        epMail: 'Please enter your email!',
        erMail: 'Please enter a correct email!',
        epPwd: 'Please enter your password!',
        erPwd: 'Please make sure the password is at least 6 characters and no more than 20 characters including letters, numbers, and symbols!',
        epResetPwd: 'Please enter your password!',
        erResetPwd: 'Please make sure the password is at least 6 characters and no more than 20 characters including letters, numbers, and symbols!',
        epRePwd:'Please enter your password again!',
        erRePwd:'The two passwords you entered do not match.',
        epPhCode: 'Please enter your mobile verification code!',
        erPhCode: 'Please enter a correct mobile verification code!',
        epEmCode: 'Please enter your email verification code!',
        erEmCode: 'Please enter a correct email verification code!',
        epName: 'Please enter your real name!',
    };