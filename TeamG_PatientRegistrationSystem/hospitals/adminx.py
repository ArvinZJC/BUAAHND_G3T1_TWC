'''
hospitals/adminx.py: Xadmin configuration
...
class HospitalInfoAdmin( object ):
    '''
    Configuration for label Hospital(s) in category Medical Service.
    '''
...
class DepartmentInfoAdmin( object ):
    '''
    Configuration for label Department(s) in category Medical Service.
    '''
...
class DoctorInfoAdmin( object ):
    '''
    Configuration for label Doctor(s) in category Medical Service.
    '''
...
class RegistrationInfoAdmin( object ):
    '''
    Configuration for label Registration in category Medical Service.
    '''
